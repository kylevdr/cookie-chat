...
this.postMessage = function(newMessage, cookieType) {
  $http({
    method: 'POST',
    url: 'http://practiceapi.devmounta.in/api/chats',
    data: {message: newMessage, cookie: cookieType}
  });
};

/*
this.changeCookie = function(cookieType) {
  $http({
    method: 'PUT',
    url: 'http://practiceapi.devmounta.in/api/?cookies=' + cookieType
  });
  var cookieObject = {
    cookieType: 3,
    macaroons: "yes"
  ...
  $http.put('http://practiceapi.devmounta.in/api/', cookieObject, cookies);
}*/
