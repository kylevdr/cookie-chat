...
$scope.getMessages = function() {
  ...
  $scope.postMessage = function(message, cookieType) {
    messageService.postMessage(message, cookieType);
    $scope.message = "";
  };

  $scope.changeCookie = function(cookieType) {
    messageService.changeCookie(cookieType);
  };

  $scope.getCookies = function() {
    messageService.getCookies().then(function(response) {
      $scope.cookieList = response.data;
    });
  };
